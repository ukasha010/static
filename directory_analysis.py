...
def save_to_csv(features_list, output_file):
    # Extract all keys from the first entry in the list
...
def analyze_file(file_path):
    file_features = {'file_name': os.path.basename(file_path)}
...
# Example usage
directory_path = r"C:\Users\ukasha\Desktop\static analysis"
output_file = "all_file_features.csv"
